...
-- ══════ 1) Busca por nome/raridade (texto)
...
-- 3) se sobrou, marca; senão, troca de servidor
if #models > 0 then
    ...
    print(("❌ Nenhum resultado por %s='%s'. Indo para outro servidor…")
